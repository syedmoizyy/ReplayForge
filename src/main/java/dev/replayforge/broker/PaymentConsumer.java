...
@Component public final class PaymentConsumer extends AbstractWorkflowConsumer {
 public PaymentConsumer(StringRedisTemplate r, EventEnvelopeSerializer s, WorkflowEngine e, WorkflowBrokerProperties p, ReplayForgeProperties i){super("payment",r,s,e,p,i);}
