...
@Component public final class PayoutConsumer extends AbstractWorkflowConsumer {
 public PayoutConsumer(StringRedisTemplate r, EventEnvelopeSerializer s, WorkflowEngine e, WorkflowBrokerProperties p, ReplayForgeProperties i){super("payout",r,s,e,p,i);}
